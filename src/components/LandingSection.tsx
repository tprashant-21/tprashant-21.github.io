...
const LandingSection = () => {
  return (
    <div className="relative flex items-end justify-center min-h-screen">
        ...
        className="absolute pt-[60px] tablet:pt-0 opacity-30  top-[50px] font-bg-font font-extrabold text-5xl tablet:text-[105px] laptop:text-[150px] normal:text-[200px] 
        text-center tracking-[5px] leading-[50px] tablet:tracking-[10px] tablet:leading-[115px] laptop:leading-[200px]">I'M A UI/UX  <span className="text-[70px] tablet:text-[150px] laptop:text-[200px] normal:text-[262px] tracking-[-2px] tablet:tracking-[-10px]">ENGINEER</span></motion.p>
