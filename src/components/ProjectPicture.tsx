...
export const WebDevPicture = ({id}: CardProps) => {
    return (
      ...
      className="absolute left-[10%] -rotate-1 top-[68%] w-[53%]  rounded-xl shadow-lg transition-transform"
        src="src/assets/images/web-disney-clone.webp"
      />
    ...
    return (
      <ProjectPicture id={id} gradient="from-[#CB6C71] to-[#E9A9AC]">
        ...
        <img
          ...
          src="src/assets/images/motion-im-yu.webp"
        />
    ...
    return (
      <ProjectPicture id={id} gradient="from-[#A59C94] to-[#DAD4CD]">
        ...
        <img
          ...
          src="src/assets/images/graphic-religion.webp"
        />
    ...
    return (
      <ProjectPicture id={id} gradient="from-[#B4838F] to-[#DAB1B7]">
        ...
        <img
          ...
          src="src/assets/images/content-honors.webp"
        />
    ...
    return (
      <ProjectPicture id={id} gradient="from-[#61817C] to-[#A7C3BB]">
        ...
        className="absolute left-[19%] top-[11%] w-[68%] rounded-xl shadow-lg transition-transform"
          src="src/assets/images/animation-3d.webp"
        />
        ...
        <img
          ...
          src="src/assets/images/animation-2d.webp"
        />
