    ...
    return (
      <ProjectPicture id={id} gradient="from-[#A59C94] to-[#DAD4CD]">
        ...
        <img
          ...
          src="../../public/graphic-religion.webp"
        />
    ...
    return (
      <ProjectPicture id={id} gradient="from-[#B4838F] to-[#DAB1B7]">
        ...
        <img
          ...
          src="../../public/content-honors.webp"
        />
