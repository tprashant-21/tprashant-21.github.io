  ...
  return (
    ...
    className="pt-[15px] h-[50px] mx-auto text-sm laptop:text-lg flex justify-around gap-x-4 font-poppins font-medium text-white">
        ...
        <div className='z-10 items-center hidden laptop:flex gap-x-6 normal:gap-x-10'>
            ...
            <a  href="#" onMouseEnter={()=>setCursor("hover")} onMouseLeave={()=>setCursor("default")} className="flex items-center px-2 duration-100 ease-in bg-black cursor-pointer hover:scale-125 rounded-xl">CV  <MdSimCardDownload className="inline-block ml-1 text-xl" /></a>
        </div>
